const project=[
    {
name:"KEEPER APP",
Description:"Developed the frontend for a note-keeping web application, 'Keeper App,' using React.js. This front-end project enables users to seamlessly create, edit, and delete notes through an intuitive user interface. Leveraging React's useState for state management, the project ensures dynamic and responsive note handling. Custom styling enhances the user experience, providing an organised and visually appealing environment.This front-end project showcases expertise in React.js, emphasising component-based architecture and front-end development skills.",
TechStack: "React.js",
...
Githublink: "https://giridharansanthoshkumar.github.io/s-mon-Game/",
},
{
...
TechStack:" HTML, CSS, JavaScript (jQuery)",
Githublink: "https://giridharansanthoshkumar.github.io/drumstick/",
},
{
name:"DICTIONARY",
